...
/// Node for autonomous flipper scenario creation
#include <ros/ros.h>
...
int main(int argc, char** argv) {
	ros::init(argc, argv, "simulation_flipper_controle_node");
	ros::NodeHandle nh;
	...
	SimulationsKontrolleFlipper simulationsKontrolleFlipper(nh);
