/*
 * GazebRandomObjectControl..h
 *
 *  Created on: 04.07.2019
 *      Author: chfo
 */

#ifndef ROS_ROBOCUP_TRAVERSABILITY_ESTIMATION_MASTER_TRAVERSABILITY_ESTIMATION_INCLUDE_TRAVERSABILITY_ESTIMATION_GazebRandomObjectControl_H_
#define ROS_ROBOCUP_TRAVERSABILITY_ESTIMATION_MASTER_TRAVERSABILITY_ESTIMATION_INCLUDE_TRAVERSABILITY_ESTIMATION_GazebRandomObjectControl_H_
...
class GazebRandomObjectControl
{

 public:
	GazebRandomObjectControl (ros::NodeHandle& nodeHandle);
	~GazebRandomObjectControl ();
...
#endif /* ROS_ROBOCUP_TRAVERSABILITY_ESTIMATION_MASTER_TRAVERSABILITY_ESTIMATION_INCLUDE_TRAVERSABILITY_ESTIMATION_GazebRandomObjectControl_H_ */
