...
#include "traversability_estimation/TraversabilityObjectiv.hpp"
...
ob::OptimizationObjectivePtr getCTraversabilityObjectivconst ob::SpaceInformationPtr& si)
 {
     return std::make_shared<TraversabilityObjectiv>(si, traversabilityMap_);
 }
/**
